...
<template>
    <div class="container py-4">
        ...
        <IngredientCard image="/images/background.webp" name="Tej" :amount="1" unit="liter" :tag="'Haramosan Lejár'"/>
        <section class="mb-5">
            <CardBase variant="outline" media-position="topLeft" tags-position="below" show-divider class="mb-3">
                ...
                <template #badge>
                    <span class="badge bg-dark text-white rounded-pill">Kipróbált</span>
                </template>
                <template #header>
                    <CardHeader>
                        <CardTitle :rank="2">Lorem ipsum dolor sit amet</CardTitle>
                        <template #actions>
                            <span class="text-secondary" title="User">👤</span>
                        </template>
                    </CardHeader>
                </template>
                <template #body>
                    <p class="small text-body-secondary mb-0 text-center">
                        Accusantium doloremque laudantium, totam rem aperiam eaque doloremque.
                    </p>
                </template>
                <template #metadata>
                    <CardMetadata>
