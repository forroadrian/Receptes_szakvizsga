...
const saveIngredient = async () => {
  ...
  if (
    currentNew.name.length == 0 ||
    currentNew.amount == null ||
    currentNew?.amount < 0 ||
    currentNew.unit.length == 0 ||
    currentNew.expiresAt.length == 0
  ) {
...
<template>
    ...
    <div class="row mt-4">
      ...
      <div>
        ...
        <div class="g-3 row mb-5 mt-4">
          <div
            class="pe-1 d-flex col-xl-4 col-lg-6 col-sm-12 flex-row justify-content-center"
  ...
  <div
    ...
    class="ingredient-modal-backdrop"
  ...
  >
    <div class="ingredient-modal-panel">
      ...
      <div class="mb-4">
        ...
        <input
          v-model="newIngredient.expiresAt"
          type="date"
          class="form-control"
        />
      </div>
